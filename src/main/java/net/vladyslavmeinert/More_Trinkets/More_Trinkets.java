...
@Mod(More_Trinkets.MOD_ID)
public class More_Trinkets {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "moretrinketspablo";
    ...
    public More_Trinkets(IEventBus modEventBus, ModContainer modContainer) {
